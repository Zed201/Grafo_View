...
public:
        ...
        { // basicamente ele troca todas as posição o nodo a ser eliminado
        ...
        string print(bool png = false)
        {
                this->png = false;
                string tmp = this->print(this->graph);
                fstream file("./Grafo.txt", ios::out);
                file << tmp;
                file.close();
                string comando = "python3 index.py Grafo Grafo_print";
                cout << comando << endl;
        ...
        void save()
        {
                string mtx = this->print(this->ret);
                fstream file("./Grafo.txt", ios::out);
                file << mtx;
                file.close();
                string comando = "python3 index.py Grafo Grafo_" + to_string(this->tmpi++);
                cout << comando << endl;
                system(comando.c_str());
        }
        ...
        string TranverseDFS(string ini, bool png = false)
        {
                this->png = png;
                this->setMark();
                this->DFS(this->Str_Int(ini));
                for (int i = 0; i < this->qtdNodo; i++)
                {
                        if (mark[i] == false)
                        {
        ...
        string TranverseBFS(string ini, bool png = false)
        {
                this->png = png;
                this->setMark();
                this->BFS(this->Str_Int(ini));
                for (int i = 0; i < this->qtdNodo; i++)
                {
